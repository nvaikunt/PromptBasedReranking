...
#SBATCH --output /projects/tir5/users/nvaikunt/qgen_nornk_exp/log2/output_eval.txt
#SBATCH --mem=32G
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_nornk_exp/log2/eval_metrics_baseline_nq_test.txt
export MODEL=/projects/tir5/users/nvaikunt/qgen_nornk_exp/model2/checkpoint-65000
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_nornk_exp/log2/eval_metrics_baseline_squad1_test.txt
bash shell_scripts/run_eval.sh
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_nornk_exp/log2/eval_metrics_baseline_trivia_test.txt
bash shell_scripts/run_eval.sh
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_nornk_exp/log2/eval_metrics_baseline_webq_test.txt
bash shell_scripts/run_eval.sh
