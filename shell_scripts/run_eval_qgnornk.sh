...
#SBATCH --output /projects/tir5/users/nvaikunt/qgen_nornk_exp/log/output_eval.txt
#SBATCH --mem=32G
...
export MODEL=/projects/tir5/users/nvaikunt/qgen_nornk_exp/model/checkpoint-30500
