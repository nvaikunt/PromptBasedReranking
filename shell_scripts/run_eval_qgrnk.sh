...
#SBATCH --output /projects/tir5/users/nvaikunt/qgen_rnk_exp_true/log/output_eval.txt
#SBATCH --mem=32G
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_rnk_exp_true/log/eval_metrics_baseline_nq_test.txt
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_rnk_exp_true/log/eval_metrics_baseline_squad1_test.txt
bash shell_scripts/run_eval.sh
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_rnk_exp_true/log/eval_metrics_baseline_trivia_test.txt
bash shell_scripts/run_eval.sh
...
export OUTFILE=/projects/tir5/users/nvaikunt/qgen_rnk_exp_true/log/eval_metrics_baseline_webq_test.txt
bash shell_scripts/run_eval.sh
